...
> 版本：v2.9 · 日期：2026-08-10（0810 增补：微信配置敏感项状态行收敛为「状态 + 操作」两段；0807 增补：平台主控台机构多选、真实 LOGO 措辞落位）
...
（9）「0722 修订」未支付订单（待支付 / 已失效）付款时间显「—」，且不渲染会员权益卡（权益未生效不展示）
...
<span style="color:#2563EB;font-weight:700">0807周五更新：父机构视角新增机构多选筛选联动全部指标
#### 1.2 主控台
...
<span style="color:#2563EB;font-weight:700">0807周五更新：父机构视角新增机构单选筛选与归属展示、子机构数据只读
#### 2.1 KP 列表
...
<span style="color:#2563EB;font-weight:700">0807周五更新：新增「TTS 参考音文本」必填字段（100 字内，不限字符种类）
#### 3.2 Agent 详情 / 编辑
...
<span style="color:#2563EB;font-weight:700">0810周一更新：微信支付新增四参数；敏感项写后不回显，0810 状态行收敛为「状态 + 操作」两段
#### 2.5 机构详情 · 机构配置
...
<span style="color:#2563EB;font-weight:700">0807周五更新：新增「TTS 参考音文本」必填字段（同机构后台）
