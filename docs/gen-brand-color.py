...
ROWS = [
    ...
    # —— 0722/0724 批次新增（订单四态 + 语音验证码兜底 + 用量看板商业化拆卡） ——
    ['机构前台 H5', '我的订单 / 订单详情（0724 新增）', '待支付条（剩余支付时间倒计时）', '警示琥珀淡底 + 琥珀字', '❌ 不需变', 'var(--amber-soft) + var(--amber-ink)', '支付时限警示语义色固定；mobile-app.css:1408'],
    ['机构前台 H5', '我的订单 / 订单详情（0724 新增）', '「去支付」按钮', '主色填充', '✅ 需变', 'var(--indigo)', '--org-primary；mobile-app.css:1410'],
