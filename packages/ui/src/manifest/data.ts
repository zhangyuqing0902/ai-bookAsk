...
export const PAGES: PageEntry[] = [
  ...
  { app: 'mobile', module: '登录与权限', name: '手机号已占用提示', path: '/login/conflict' },
  { app: 'mobile', module: '登录与权限', name: '二维码失效', path: '/qr-invalid' },
  { app: 'mobile', module: 'AI 会话', name: 'KP 前台入口(状态判活)', path: '/kp/:kpId', linkPath: '/kp/kp_anesthesia' },
  ...
  { app: 'mobile', module: '我的', name: '我的纸书', path: '/me/books' },
  ...
  { app: 'mobile', module: '我的', name: '个人资料', path: '/me/profile' },
  ...
  { app: 'org', module: '产品中心', name: 'KP 详情', path: '/kps/:id', linkPath: '/kps/1' },
  ...
  { app: 'org', module: '数据中心', name: '答案反馈', path: '/feedback' },
  { app: 'org', module: '系统设置', name: '客服配置', path: '/cs' },
  { app: 'org', module: '系统设置', name: '系统配置', path: '/sys' },
  { app: 'org', module: '账户', name: '个人中心', path: '/profile' },
  { app: 'org', module: '登录', name: '登录页', path: '/login' },

  // ============ 平台超管（platform） ============
  { app: 'platform', module: '主控台', name: '主控台', path: '/' },
  { app: 'platform', module: '机构管理', name: '机构管理', path: '/orgs' },
  { app: 'platform', module: '机构管理', name: '机构详情', path: '/orgs/:id', linkPath: '/orgs/org_med' },
  { app: 'platform', module: '机构管理', name: '机构账户管理', path: '/accounts' },
  { app: 'platform', module: '机构管理', name: '订阅订单', path: '/subscriptions' },
  { app: 'platform', module: '产品中心', name: '全域知识产品 KP', path: '/global-kps' },
  { app: 'platform', module: '产品中心', name: '全域知识产品 KP 详情', path: '/global-kps/:id', linkPath: '/global-kps/kp_cardio' },
  { app: 'platform', module: '产品中心', name: '全域 Agent 人设', path: '/global-agents' },
  { app: 'platform', module: '产品中心', name: '全域 Agent 详情', path: '/global-agents/:id', linkPath: '/global-agents/0' },
  { app: 'platform', module: '运营中心', name: '全域用户', path: '/users' },
  { app: 'platform', module: '运营中心', name: '全域用户详情', path: '/users/:id', linkPath: '/users/u1' },
  { app: 'platform', module: '运营中心', name: '全域订单', path: '/orders' },
  { app: 'platform', module: '运营中心', name: '全域订单详情', path: '/orders/:id', linkPath: '/orders/o1' },
  { app: 'platform', module: '数据中心', name: '全域答案反馈', path: '/global-feedback' },
  { app: 'platform', module: '数据中心', name: '全域模型用量', path: '/model' },
  { app: 'platform', module: '系统设置', name: '平台账户', path: '/platform-accounts' },
  { app: 'platform', module: '系统设置', name: '角色与权限', path: '/roles' },
  { app: 'platform', module: '系统设置', name: '默认 LLM 配置', path: '/llm' },
  { app: 'platform', module: '账户', name: '个人中心', path: '/profile' },
